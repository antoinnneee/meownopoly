...
1. Lire le AGENTS.md du repo (sections Architecture, QML gotchas, Dev test harness).
...
- **CMake GLOB_RECURSE est figé au configure** : reconfigurer AVANT de
  builder après tout ajout de `.cpp` (cf. commandes dans AGENTS.md).
...
- Reporter les gotchas nouveaux dans AGENTS.md seulement s'ils sont
