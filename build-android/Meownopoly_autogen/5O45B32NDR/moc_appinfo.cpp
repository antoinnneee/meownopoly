...
#include "../../../Meownopoly/cpp/tools/appinfo.h"
...
template <> constexpr inline auto AppInfo::qt_create_metaobjectdata<qt_meta_tag_ZN7AppInfoE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<AppInfo, qt_meta_tag_ZN7AppInfoE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject AppInfo::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7AppInfoE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7AppInfoE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN7AppInfoE_t>.metaTypes,
    nullptr
} };
...
void AppInfo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: { QString _r = _t->getVersionName();
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (AppInfo::*)()>(_a, &AppInfo::nameChanged, 0))
            return;
    }
...
void *AppInfo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7AppInfoE_t>.strings))
