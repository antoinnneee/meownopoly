                    ...
                    Flow {
                        ...
                        Repeater {
                            model: [
                                ...
                                {icon: "🌳", label: "Décorations", value: "6", color: "#FFC107"},
                                // {icon: "🎮", label: "Joueurs", value: "4", color: "#4CAF50"},
                                {icon: "🎲", label: "Événements", value: "12", color: "#E91E63"}
                            ]
