...
Dialog {
    ...
    property Player monPlayer: Game.getPlayer();
    ...
    property var availableColors: [
        ...
        "#1e40af", "#dc2626", "#166534"  // Bleu profond, Rouge profond, Vert profond
    ]
    ...
    function generateAvatarList() {
        ...
        for (var i = 1; i <= 6; i++) {
            console.log("avatar asset path cahnged")
                        ...
                        RowLayout {
                            ...
                            Button {
                                ...
                                Menu {
                                    ...
                                    property int playerIndex: index  // Sauvegarder l'index du joueur
                                    ...
                                    Repeater {
                                        ...
                                        MenuItem {
                                            ...
                                            onClicked: {
                                                playersModel.setProperty(colorMenu.playerIndex, "color", modelData)
                                                colorMenu.close()
                                            }
                                        }
                                    }
