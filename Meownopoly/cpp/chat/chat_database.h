...
public:
    ...
    bool init();
    bool saveMessage(const QString &sessionId, const QString &senderId, const QString &senderNickname, const QByteArray &payload, const QByteArray &nonce, const QString &timestamp, int keyVersion);
