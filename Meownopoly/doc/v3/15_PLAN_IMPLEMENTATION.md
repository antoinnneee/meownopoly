...
| C7 · Tchat ingame IA — **implémenté (UI + invocation)** | `AiChatDrawer`, distinct du chat multijoueur : ouverture automatique dans l'éditeur IA, boutons classique/nouveau chrome, une invocation proposant par tour, réponses/verdicts/progression et info captures D22. L'orchestration complète proposant→arbitre reste portée par S-1/S-2. | **É** |
