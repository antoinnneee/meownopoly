...
template <> constexpr inline auto CaseRestArea::qt_create_metaobjectdata<qt_meta_tag_ZN12CaseRestAreaE_t>()
{
    ...
    QtMocHelpers::UintData qt_properties {
        ...
        QtMocHelpers::PropertyData<RestQuality>(11, 0x80000000 | 12, QMC::DefaultPropertyFlags | QMC::Writable | QMC::EnumOrFlag | QMC::StdCppSet, 0),
        // property 'family'
        QtMocHelpers::PropertyData<enum FamilyType>(13, 0x80000000 | 14, QMC::DefaultPropertyFlags | QMC::Writable | QMC::EnumOrFlag | QMC::StdCppSet, 1),
        // property 'housePrice'
        QtMocHelpers::PropertyData<int>(15, QMetaType::Int, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet | QMC::Final, 2),
        // property 'hotelPrice'
        QtMocHelpers::PropertyData<int>(16, QMetaType::Int, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet | QMC::Final, 3),
        // property 'rentPrice'
        QtMocHelpers::PropertyData<QList<int>>(17, 0x80000000 | 18, QMC::DefaultPropertyFlags | QMC::Writable | QMC::EnumOrFlag | QMC::StdCppSet | QMC::Final, 4),
    };
    QtMocHelpers::UintData qt_enums {
        // enum 'RestQuality'
        QtMocHelpers::EnumData<RestQuality>(12, 12, QMC::EnumFlags{}).add({
            {   19, RestQuality::RQ_NONE },
            {   20, RestQuality::RQ_1STAR },
            {   21, RestQuality::RQ_2STAR },
            {   22, RestQuality::RQ_3STAR },
            {   23, RestQuality::RQ_4STAR },
            {   24, RestQuality::RQ_HOTEL },
            {   25, RestQuality::RQ_COUNT },
        }),
        // enum 'FamilyType'
        QtMocHelpers::EnumData<FamilyType>(14, 14, QMC::EnumFlags{}).add({
            {   26, FamilyType::FT_NONE },
            {   27, FamilyType::FT_BROWN },
            {   28, FamilyType::FT_LIGHTBLUE },
            {   29, FamilyType::FT_PINK },
            {   30, FamilyType::FT_ORANGE },
            {   31, FamilyType::FT_RED },
            {   32, FamilyType::FT_YELLOW },
            {   33, FamilyType::FT_GREEN },
            {   34, FamilyType::FT_DARKBLUE },
            {   35, FamilyType::FT_COUNT },
        }),
    };
...
void CaseRestArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast<RestQuality*>(_v) = _t->restQuality(); break;
    ...
    if (_c == QMetaObject::WriteProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setRestQuality(*reinterpret_cast<RestQuality*>(_v)); break;
