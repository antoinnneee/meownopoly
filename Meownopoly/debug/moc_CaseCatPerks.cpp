...
template <> constexpr inline auto CaseCatPerks::qt_create_metaobjectdata<qt_meta_tag_ZN12CaseCatPerksE_t>()
{
    ...
    QtMocHelpers::UintData qt_properties {
        // property 'price'
        QtMocHelpers::PropertyData<int>(9, QMetaType::Int, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet | QMC::Final, 0),
        // property 'sellPrice'
        QtMocHelpers::PropertyData<int>(10, QMetaType::Int, QMC::DefaultPropertyFlags | QMC::Writable | QMC::Final, 1),
        // property 'morgagePrice'
        QtMocHelpers::PropertyData<int>(11, QMetaType::Int, QMC::DefaultPropertyFlags | QMC::Writable | QMC::Final, 2),
        // property 'owner'
        QtMocHelpers::PropertyData<Player*>(12, 0x80000000 | 7, QMC::DefaultPropertyFlags | QMC::EnumOrFlag, 3),
    };
